 ...
 * ```
 */
export type ValidatorRuleConfigMessage =
  | string
  | ((
      options: MakeRequired<
        Omit<ValidatorOptions, 'sanitizedRules' | 'rules' | 'rule'>,
...
>
  extends
    Omit<
      ValidatorClassOptions<TClass, Context, [classInstance: TClass]>,
      'data'
    >,
...
>
  extends ValidatorOptions<RulesFunctions, Context>, ValidatorMessageConfig {
  startTime?: number;
}
/**
